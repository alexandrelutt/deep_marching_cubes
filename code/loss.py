...
class MyLoss(object):
    ...
    def loss(self, offset, topology, pts, occupancy):
        ...
        print('loss_point_to_mesh: ', loss_point_to_mesh/batch_size)
        print('loss_occupancy: ', loss_occupancy/batch_size)
        print('loss_smoothness: ', loss_smoothness/batch_size)
        print('loss_curvature: ', loss_curvature/batch_size)
